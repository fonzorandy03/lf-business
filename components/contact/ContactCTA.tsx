...
export function ContactCTA() {
  return (
    <section className="relative isolate overflow-hidden bg-ink py-24 lg:py-32">
      <div
        aria-hidden="true"
        className="absolute -right-32 -top-32 -z-10 h-[34rem] w-[34rem] rounded-full bg-gold/[0.06] blur-3xl"
      />
      <div className="mx-auto max-w-3xl px-6 text-center lg:px-10">
        <Reveal>
          ...
          <h2 className="font-serif text-4xl font-medium leading-[1.05] text-ivory text-balance sm:text-5xl">
            Un contatto diretto, quando serve.
          </h2>
          <span className="mx-auto mt-6 block h-px w-16 bg-gold" aria-hidden="true" />
          <p className="mx-auto mt-7 max-w-xl text-base leading-relaxed text-ivory/65 sm:text-lg">
            Siamo a disposizione per approfondire la tua richiesta e individuare l&apos;ambito di
            assistenza più appropriato.
          </p>
        </Reveal>
