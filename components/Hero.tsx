...
export function Hero() {
  return (
    <section className="site-hero home-hero relative flex min-h-[100svh] items-center overflow-hidden bg-ink">
      {/* Background */}
      ...
      <div className="site-hero-content relative z-10 mx-auto w-full max-w-7xl px-6 pt-28 pb-36 sm:pt-32 sm:pb-32 lg:px-10">
